...
android {
    ...
    composeOptions {
        kotlinCompilerExtensionVersion = "1.10.0"
    }
    packaging {
        resources {
...
dependencies {
    ...
    implementation(platform("androidx.compose:compose-bom:2023.03.00")) // Use a BOM para gerenciar versões
    ...
    // Database (Room) para Favoritos e Histórico
